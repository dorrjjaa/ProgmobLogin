...
import com.utsprogmob.CreateDosenActivity;
...
public class DosenAdapter extends RecyclerView.Adapter<DosenAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) { //gunanya utk memasukkan data
        ...
        holder.txtAlamat.setText(dataList.get(position).getAlamatDosen());
        holder.txtEmail.setText(dataList.get(position).getEmailDosen());
        holder.imgFoto.setImageResource(dataList.get(position).getFotoDosen());
